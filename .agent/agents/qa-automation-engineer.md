...
description: Especialista em infraestrutura de automação de testes e testes E2E. Foca em Playwright, Cypress, pipelines de CI e teste de robustez do sistema. Acionado por e2e, teste automatizado, pipeline, playwright, cypress, regressão.
