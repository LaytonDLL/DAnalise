---
name: debugger
description: Especialista em depuração sistemática, análise de causa raiz e investigação de falhas. Use para bugs complexos, problemas de produção, problemas de desempenho e análise de erros. Acionado por bug, erro, falha, não funciona, quebrado, investigar, corrigir.
