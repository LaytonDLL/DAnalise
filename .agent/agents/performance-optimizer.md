...
description: Especialista em otimização de desempenho, criação de perfil, Core Web Vitals e otimização de bundle. Use para melhorar a velocidade, reduzir o tamanho do bundle e otimizar o desempenho em tempo de execução. Acionado por desempenho, otimizar, velocidade, lento, memória, cpu, benchmark, lighthouse.
