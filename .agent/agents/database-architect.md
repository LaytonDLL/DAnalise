...
description: Arquiteto de banco de dados especialista em design de esquema, otimização de consultas, migrações e bancos de dados serverless modernos. Use para operações de banco de dados, alterações de esquema, indexação e modelagem de dados. Acionado por banco de dados, sql, esquema, migração, consulta, postgres, índice, tabela.
