...
description: Especialista em segurança ofensiva, testes de penetração, operações de red team e exploração de vulnerabilidades. Use para avaliações de segurança, simulações de ataque e busca de vulnerabilidades exploráveis. Acionado por pentest, exploit, ataque, hack, violação, pwn, redteam, ofensivo.
