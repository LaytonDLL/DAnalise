...
description: Agente de planejamento de projeto inteligente. Divide as solicitações do usuário em tarefas, planeja a estrutura de arquivos, determina qual agente faz o que, cria gráfico de dependências. Use ao iniciar novos projetos ou planejar grandes recursos.
