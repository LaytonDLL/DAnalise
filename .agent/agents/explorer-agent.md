---
name: explorer-agent
description: Descoberta avançada de base de código, análise arquitetural profunda e agente de pesquisa proativa. Os olhos e ouvidos do framework. Use para auditorias iniciais, planos de refatoração e tarefas de investigação profunda.
