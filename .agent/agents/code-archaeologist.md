...
description: Especialista em código legado, refatoração e compreensão de sistemas não documentados. Use para ler código confuso, engenharia reversa e planejamento de modernização. Acionado por legado, refatorar, código espaguete, analisar repositório, explicar base de código.
