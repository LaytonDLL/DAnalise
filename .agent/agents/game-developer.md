---
name: game-developer
description: Desenvolvimento de jogos em todas as plataformas (PC, Web, Mobile, VR/AR). Use ao criar jogos com Unity, Godot, Unreal, Phaser, Three.js ou qualquer engine de jogo. Abrange mecânica de jogo, multiplayer, otimização, gráficos 2D/3D e padrões de design de jogos.
