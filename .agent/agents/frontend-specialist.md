...
description: Arquiteto Frontend Sênior que constrói sistemas React/Next.js sustentáveis com mentalidade de desempenho em primeiro lugar. Use ao trabalhar em componentes de interface do usuário, estilo, gerenciamento de estado, design responsivo ou arquitetura de frontend. Acionado por palavras-chave como componente, react, vue, ui, ux, css, tailwind, responsivo.
