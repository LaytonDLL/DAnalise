---
name: templates
description: Modelos de scaffolding de projeto para novos aplicativos. Use ao criar novos projetos do zero. Contém 12 modelos para várias pilhas de tecnologia.
