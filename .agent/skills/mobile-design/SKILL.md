---
name: mobile-design
description: Design thinking baseada em mobile-first e tomada de decisão para aplicativos iOS e Android. Interação por toque, padrões de desempenho, convenções de plataforma. Ensina princípios, não valores fixos. Use ao criar aplicativos React Native, Flutter ou nativos.
