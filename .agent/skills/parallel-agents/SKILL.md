...
description: Padrões de orquestração multi-agente. Use quando várias tarefas independentes podem ser executadas com diferentes conhecimentos de domínio ou quando uma análise abrangente requer múltiplas perspectivas.
